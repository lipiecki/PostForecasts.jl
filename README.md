...
Currently, the package includes four postprocessing models that differ in terms of computational complexity and assumptions about the underlying distributions.
...
We believe that following these three principles allowed us to develop a robust tool for computing probabilistic forecasts that combines ease of use, high accuracy, fast results and good interpretability. This makes Probcasts.jl an attractive choice for both academic and industrial applications.
